...
objects_reports <- load_rdatas(type = 'Global')
...
`measured_vars` argument must be a character vector with the transpiration
variables measured, allowing for comparing the total E measured in the plots with
the total E modelled only for those cohorts measured.
...
with only the measured cohorts.  

This will impact the plot and statistics functions, as they report only for
measured cohorts, not total of cohorts present in the plot.

...
if (params$transpMode %in% c('both')) {
  ...
  if (params$transpMode %in% c('simple')) {
    sp_names <- paste0('E_sp', simple_input$above$SP)
    models_dfs <- saveRes(res_simple, sp_names = sp_names, spParams = sp_params,
                          site_code = params$code)
  } else {
    sp_names <- paste0('E_sp', complex_input$above$SP)
    models_dfs <- saveRes(complex_res = res_complex, sp_names = sp_names,
...
```{r statistics_SWC}
SWC_MAE_simple <- MAE_calculator(measuredData[['SWC']],
                                 models_dfs[['simple']][['W.1']] * soil_object$Theta_FC[[1]])
SWC_MAE_complex <- MAE_calculator(measuredData[['SWC']],
                                  models_dfs[['complex']][['W.1']] * soil_object$Theta_FC[[1]])
SWC_MAE_both <- MAE_calculator(models_dfs[['complex']][['W.1']] * soil_object$Theta_FC[[1]],
                               models_dfs[['simple']][['W.1']] * soil_object$Theta_FC[[1]])

SWC_r_sq_simple <- r_squared_calculator(measuredData[['SWC']],
                                    models_dfs[['simple']][['W.1']] * soil_object$Theta_FC[[1]])
SWC_r_sq_complex <- r_squared_calculator(measuredData[['SWC']],
                                     models_dfs[['complex']][['W.1']] * soil_object$Theta_FC[[1]])
SWC_r_sq_both <- r_squared_calculator(models_dfs[['complex']][['W.1']] * soil_object$Theta_FC[[1]],
                                  models_dfs[['simple']][['W.1']] * soil_object$Theta_FC[[1]])

SWC_bias_simple <- bias_calculator(measuredData[['SWC']],
                                   models_dfs[['simple']][['W.1']] * soil_object$Theta_FC[[1]])
SWC_bias_complex <- bias_calculator(measuredData[['SWC']],
                                    models_dfs[['complex']][['W.1']] * soil_object$Theta_FC[[1]])
SWC_bias_both <- bias_calculator(models_dfs[['complex']][['W.1']] * soil_object$Theta_FC[[1]],
                                 models_dfs[['simple']][['W.1']] * soil_object$Theta_FC[[1]])
```

Comparision | MAE | r² | Bias
------------|-----|----|-------
Simple *vs.* Measured | `r SWC_MAE_simple` | `r SWC_r_sq_simple` | `r SWC_bias_simple`
Complex *vs.* Measured | `r SWC_MAE_complex` | `r SWC_r_sq_complex` | `r SWC_bias_complex`
Simple *vs.* Complex | `r SWC_MAE_both` | `r SWC_r_sq_both` | `r SWC_bias_both`


```{r plots_SWC, fig.height=6, fig.width=8}
par(mfrow = c(2,3))
...
```{r statistics_Eplanttot, eval = FALSE}
Eplanttot_MAE_simple <- MAE_calculator(measuredData[['Eplanttot']],
                                       models_dfs[['simple']][['Eplanttot']])
Eplanttot_MAE_complex <- MAE_calculator(measuredData[['Eplanttot']],
                                        models_dfs[['complex']][['Eplanttot']])
Eplanttot_MAE_both <- MAE_calculator(models_dfs[['complex']][['Eplanttot']],
                                     models_dfs[['simple']][['Eplanttot']])

Eplanttot_r_sq_simple <- r_squared_calculator(measuredData[['Eplanttot']],
                                              models_dfs[['simple']][['Eplanttot']])
Eplanttot_r_sq_complex <- r_squared_calculator(measuredData[['Eplanttot']],
                                               models_dfs[['complex']][['Eplanttot']])
Eplanttot_r_sq_both <- r_squared_calculator(models_dfs[['complex']][['Eplanttot']],
                                            models_dfs[['simple']][['Eplanttot']])

Eplanttot_bias_simple <- bias_calculator(measuredData[['Eplanttot']],
                                         models_dfs[['simple']][['Eplanttot']])
Eplanttot_bias_complex <- bias_calculator(measuredData[['Eplanttot']],
                                          models_dfs[['complex']][['Eplanttot']])
Eplanttot_bias_both <- bias_calculator(models_dfs[['complex']][['Eplanttot']],
                                       models_dfs[['simple']][['Eplanttot']])
```

Comparision | MAE | r² | Bias
------------|-----|----|-------
Simple *vs.* Measured | `r #Eplanttot_MAE_simple` | `r #Eplanttot_r_sq_simple` | `r #Eplanttot_bias_simple`
Complex *vs.* Measured | `r #Eplanttot_MAE_complex` | `r #Eplanttot_r_sq_complex` | `r #Eplanttot_bias_complex`
Simple *vs.* Complex | `r #Eplanttot_MAE_both` | `r #Eplanttot_r_sq_both` | `r #Eplanttot_bias_both`


```{r plots_Eplanttot, fig.height=8, fig.width=8, eval=FALSE}
par(mfrow = c(2,3))

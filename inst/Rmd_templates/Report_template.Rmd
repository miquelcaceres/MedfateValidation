...
```{r plots_SWC, fig.height=6, fig.width=8, eval = FALSE}
par(mfrow = c(2,3))
...
Complex *vs.* Measured | `r #Eplanttot_stats$Eplanttot_MAE_complex` | `r #EEplanttot_stats$planttot_r_sq_complex` | `r #Eplanttot_stats$Eplanttot_bias_complex`

...
plot_res('SWC', models_dfs, soil_object, measuredData, params$transpMode)
```
...
plot_res('Eplanttot', models_dfs, soil_object, measuredData, params$transpMode)
```
...
```{r plots_Eplant_coh, fig.height=6, fig.width=8}
plot_res('E_by_Cohort', models_dfs, soil_object, measuredData, params$transpMode)
```
